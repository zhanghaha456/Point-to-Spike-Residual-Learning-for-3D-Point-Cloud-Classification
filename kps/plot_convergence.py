...
def compare_convergences_classif(list_of_paths, list_of_labels=None):
    ...
    for path in list_of_paths:
        ...
        if exists(file):
            ...
            vote_PRE, vote_REC, vote_F1, vote_IoU, vote_ACC = smooth_metrics(vote_C2, smooth_n=0)
        else:
            vote_C2 = val_C1
...
def experiment_name_1():
    ...
    start = 'sacn-1step-0.32-SEW-1,Log_2023-06-15_11-16-54'
    end = 'scan-1step-0.32-sew,Log_2023-06-13_09-28-48'
...
def experiment_name_2():
    ...
    # Using the dates of the logs, you can easily gather consecutive ones. All logs should be of the same dataset.
    start = 'sacn-1step-0.32-SEW-1,Log_2023-06-15_11-16-54'
    end = 'scan-1step-0.32-ms-yuzhi,Log_2023-06-13_07-51-17'
    ...
    logs = np.insert(logs, 0, 'results/Log_2023-04-02_08-06-33')
